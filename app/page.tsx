    ...
    <div className="min-h-screen bg-[#f8f9fa] text-[#191c1d]">
      ...
      <main>
        <section className="mx-auto flex max-w-7xl flex-col items-center px-4 pb-20 pt-28 text-center sm:px-6 md:pb-28 md:pt-36 lg:px-10">
          ...
          <div className="mt-10 flex w-full flex-col justify-center gap-3 sm:w-auto sm:flex-row md:mt-12"><ButtonLink href="/register" variant="accent">Empezá gratis<ArrowRight aria-hidden="true" className="size-4" /></ButtonLink><ButtonLink href="#demo" variant="outline">Ver video demo</ButtonLink></div>
        ...
        <section id="comenzar" className="flex flex-col items-center px-4 py-20 text-center md:py-24"><h2 className="text-2xl font-semibold tracking-[-0.025em] text-black sm:text-3xl">¿Listo para construir tu próxima idea?</h2><ButtonLink href="/register" className="mt-8 px-8 py-4">Comenzar mi proyecto</ButtonLink></section>
      </main>
