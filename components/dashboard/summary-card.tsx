    ...
    <Card className="group transition-[border-color,box-shadow,transform] hover:-translate-y-0.5 hover:border-[#c7c8c9] hover:shadow-[0_16px_32px_-22px_rgba(15,23,42,0.4)]">
      <CardContent className="p-5 sm:p-5">
        <div className="flex items-start justify-between gap-4">
          <span className={`grid size-10 place-items-center rounded-lg ${accents[accent]}`}><Icon aria-hidden="true" className="size-[1.1rem]" /></span>
        ...
        <p className="mt-6 text-3xl font-semibold text-black">{value}</p>
